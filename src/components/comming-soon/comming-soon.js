...
import iiitdm from './IIITDM@2x.png';
import vashisth from './Vashisht Logo@2x.png';
import vastext from './Vashisht Text@2x.png'
// import commtag from './Coming Soon Tape.png';
