			...
			<Container className="team1">
				...
				<Row className="team">
					{Data.organizers.map(items => (
						<Col key={items.number} lg={3}>
							<Team image={items.image} name={items.name} number={items.number} facebook={items.facebook} linkedin={items.linkedin} instagram={items.instagram} />
						</Col>
					))}
				</Row>
				<hr></hr>
				...
				<Row className="team">
					{Data.webops.map(items => (
						<Col key={items.number} lg={6}>
							<Teamwo image={items.image} name={items.name} number={items.number} github={items.github} linkedin={items.linkedin} instagram={items.instagram} />
						</Col>
					))}
				</Row>
				<hr></hr>
